...
import { postTodosApi, putTodosApi } from '../../../../../../services/todos.service';
import { postTagsApi, postTodosTagsApi, deleteTodosTagsApi } from '../../../../../../services/tags.service';
import { UserUUIDContext } from '../../../UserUUIDContext';
...
const AddTodoForm = (props) => {
  const [todoHandler, setTodoHandler] = useState(() => () => 'todoHandler has not yet been set');
  ...
  const {
    taskName, description, tags, priority, todoId, due, list,
  } = inputState;
    ...
    <div id="AddTodoForm" onSubmit={(event) => { handleSubmit(event, inputState, initialInputState, setErrors, todoHandler, addTag, addTodosTags, deleteTodosTags, props.loadTodos, props.loadTags, props.exit, resetForm); }}>
      <form id={styles.addTodoForm}>
        ...
        <div id={styles.buttons}>
          <button id={styles.cancel} type="button" onClick={props.exit}> Cancel </button>
